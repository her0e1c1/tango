...
| CARD-22 | write | [退出後の Card 更新結果を適切に扱う](./card-list-actions.md#card-22) |
...
| CARD-26 | read | [未保存の Card 作成内容の離脱を確認できる](./card-management.md#card-26) |
...
| ID | カテゴリ | テストケース |
| --- | --- | --- |
| HISTORY-01 | write | [30日分の学習記録](./study-session.md#history-01) |
| HISTORY-02 | read | [URLとデッキ選択](./study-session.md#history-02) |
| HISTORY-03 | read | [表示できないデッキ](./study-session.md#history-03) |
| HISTORY-04 | write | [匿名の端末内学習記録](./study-session.md#history-04) |
