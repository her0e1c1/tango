...
| SETTINGS-03 | write | [日本語設定を自動保存して reload 後も反映できる](./settings.md#settings-03) |
| SETTINGS-04 | write | [System 設定で browser locale を解決して reload 後も反映できる](./settings.md#settings-04) |
