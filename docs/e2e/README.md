...
| SETTINGS-04 | write | [Language 設定と document locale を reload 後も維持できる](./settings.md#settings-04) |
| SETTINGS-05 | read | [System language 設定で browser locale の変更を textarea に反映できる](./settings.md#settings-05) |
...
| SWIPE-25 | read | [Help button 表示設定を next/previous の移動後も維持できる](./study-controls.md#swipe-25) |
