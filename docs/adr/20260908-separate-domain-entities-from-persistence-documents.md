...
各Entityのpersistence APIは自身が所有するfieldだけをwriteまたはpatchし、共有document内の他Entity fieldを上書きしない。Card contentとStudyProgressはこの方針で同じCard documentを共有する。[PR #613](https://github.com/her0e1c1/tango/pull/613)、[PR #905](https://github.com/her0e1c1/tango/pull/905)、[PR #1123](https://github.com/her0e1c1/tango/pull/1123)を参照する。
