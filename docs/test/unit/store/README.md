...
| UNIT-STORE-CARD-04 | Card | 正常系 | [カードの作成・編集・削除を最新の取得結果に合わせて反映する](./card.md#unit-store-card-04) |
| UNIT-STORE-CARD-05 | Card | 異常系 | [カードの保存に失敗しても取得済みのカードを維持する](./card.md#unit-store-card-05) |
...
| UNIT-STORE-DECK-03 | Deck | 正常系 | [デックの作成・編集・削除を最新の取得結果に合わせて反映する](./deck.md#unit-store-deck-03) |
| UNIT-STORE-DECK-04 | Deck | 異常系 | [デックの保存に失敗しても取得済みのデックを維持する](./deck.md#unit-store-deck-04) |
...
| UNIT-STORE-STUDY-07 | Study Session | 正常系 | [新しく始めた学習を取得するとその学習の続きから再開できる](./study-session.md#unit-store-study-07) |
| UNIT-STORE-STUDY-08 | Study Session | 正常系 | [取得した学習の進行・再開・終了に合わせて続きを更新する](./study-session.md#unit-store-study-08) |
| UNIT-STORE-STUDY-09 | Study Session | 異常系 | [学習の保存に失敗しても取得済みの続きを維持する](./study-session.md#unit-store-study-09) |
| UNIT-STORE-STUDY-10 | Study Session | 正常系 | [学習の取得中は所有者に合う続きを保持し取得後に待機を終える](./study-session.md#unit-store-study-10) |
| UNIT-STORE-STUDY-11 | Study Session | 異常系 | [学習の取得に失敗したら待機を終えて取得済みの続きを維持する](./study-session.md#unit-store-study-11) |
