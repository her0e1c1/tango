...
| DECK-NAVIGATION-05 | write | 正常系 | [現在の tag filter に一致する全 Card を標準順で閲覧できる](#deck-navigation-05) |
| DECK-NAVIGATION-06 | read | 正常系 | [復習期日の設定を閲覧対象へ反映できる](#deck-navigation-06) |
