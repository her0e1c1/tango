...
import { card } from "@/storybook/fixture";
...
export const Unstudied: Story = {
  args: { card: { ...card.default, numberOfSeen: 0, score: 0 } },
};

export const LongText: Story = { args: { card: card.long } };
export const LongTags: Story = { args: { card: card.longTags } };
