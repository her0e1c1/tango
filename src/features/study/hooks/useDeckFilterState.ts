 ...
 */
export const useDeckFilterState = ({ deck, editDeck, tags }: UseDeckFilterStateOptions): DeckStartFormProps => {
  ...
  React.useEffect(() => {
    return subscribe({
      ...
      callback: () =>
        void handleSubmit((data) => (editDeck == null ? undefined : editDeck(uid, data).catch(() => undefined)))(),
    });
  }, [editDeck, handleSubmit, subscribe, uid]);
