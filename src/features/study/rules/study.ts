 ...
 * remote services.
 */
import type { CardSwipeAction, ConfigState, SwipeDirection } from "@/entities/config";
 ...
 */
export const calculateCardScore = (card: Pick<Card, "score">, swipeAction: CardSwipeAction): number => {
 ...
 */
export const calculateNextIndex = (currentIndex: number, cardCount: number, swipeAction: CardSwipeAction): number => {
