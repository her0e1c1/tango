...
describe("DeckEditForm", () => {
  ...
  it("saves edited form values for the authenticated user and reports success", async () => {
    const onSaved = vi.fn();
    render(<DeckEditForm deck={deck} editDeck={mocks.editDeck} onCancel={vi.fn()} onSaved={onSaved} />);
  ...
  it("uses the form submit state while saving", async () => {
    ...
    render(<DeckEditForm deck={deck} editDeck={mocks.editDeck} onCancel={vi.fn()} onSaved={vi.fn()} />);
  ...
  it("forwards cancellation from both navigation actions", async () => {
    ...
    render(<DeckEditForm deck={deck} editDeck={mocks.editDeck} onCancel={onCancel} onSaved={vi.fn()} />);
