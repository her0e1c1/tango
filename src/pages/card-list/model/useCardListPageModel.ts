...
import { goToDeckList } from "./actions/goToDeckList";
import { goToSettings } from "./actions/goToSettings";
import { goToCardCreate } from "./actions/goToCardCreate";
import { goToCardEdit } from "./actions/goToCardEdit";
...
export function useCardListPageModel(deck: Deck) {
  ...
  return {
    ...
    goToDeckList: () => goToDeckList(navigate, controls.dialogOpen),
    goToSettings: () => goToSettings(navigate, controls.dialogOpen),
    goToCardCreate: () => goToCardCreate(navigate, deck.id),
    goToCardEdit: (id: CardId) => goToCardEdit(navigate, id),
