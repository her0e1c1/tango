...
import { useDeckImportState } from "./useDeckImportState";
  ...
  renderHook(() => {
    ...
    return {
      deckImport: {
        ...
        setStorageMode: (mode: DeckImportStorageMode) =>
        ...
        importPreview: () =>
          importDeckPreview(controls.uid, state.previewState.preview, state.preparedImportRef, feedback),
        addSample: () => addSampleImport(controls.uid, feedback),
        storageMode: state.previewState.storageMode,
...
describe("Deck import operations [IMPORT-01 IMPORT-02 IMPORT-04 IMPORT-05 IMPORT-06]", () => {
  beforeEach(() => {
    controls.uid = "";
    controls.nextMutationError = undefined;
    controls.nextMutationWait = undefined;
