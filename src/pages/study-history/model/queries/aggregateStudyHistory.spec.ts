...
describe("STUDY-SESSION-09 STUDY-SESSION-13 daily study counts", () => {
  registerCountsACompletedSessionOnceInBothMetricsAndIncludes30CalendarDays();

  registerCountsIndependentStartsAndCompletionsOnTheirOwnCalendarDates();

  registerRetainsMoreThan100RecordsAndExcludesUnavailableDecksWithoutDisplacingVisibleRecords();

  registerUsesLocalMidnightsAcrossMonthYearAndDaylightSavingBoundariesS();

  registerIncludesBothLocalDateBoundariesInSS();
});

function registerCountsACompletedSessionOnceInBothMetricsAndIncludes30CalendarDays() {
...
function registerCountsIndependentStartsAndCompletionsOnTheirOwnCalendarDates() {
...
function registerRetainsMoreThan100RecordsAndExcludesUnavailableDecksWithoutDisplacingVisibleRecords() {
...
function registerUsesLocalMidnightsAcrossMonthYearAndDaylightSavingBoundariesS() {
...
function registerIncludesBothLocalDateBoundariesInSS() {
  it.each([
