  ...
  en: {
    translation: {
      ...
      studyHistory: {
        ...
        started: "Decks started (cumulative)",
        completed: "Decks completed (cumulative)",
        empty: "No study records in this period.",
        daily: "Daily study counts",
        chart: "Study history chart",
        chartHelp: "Daily starts and completions. Exact values are in the daily table below.",
        table: "Daily counts",
        date: "Date",
  ...
  ja: {
    translation: {
      ...
      studyHistory: {
        ...
        started: "開始したデッキ数（延べ）",
        completed: "完了したデッキ数（延べ）",
        empty: "この期間の学習記録はありません。",
        daily: "日別の学習回数",
        chart: "学習記録のグラフ",
        chartHelp: "日別の開始・完了数です。正確な数値は下の日別表で確認できます。",
        table: "日別の件数",
        date: "日付",
