  ...
  en: {
    translation: {
      ...
      deckList: {
        ...
        noReviewCards: "No due or new cards",
        studyPosition: "Studying · Card {{position}} of {{total}}",
        ...
        openCards: "Open cards in {{deckName}}",
        remote: "Remote deck",
  ...
  ja: {
    translation: {
      ...
      deckList: {
        ...
        noReviewCards: "復習・新規なし",
        studyPosition: "学習中 {{position}} / {{total}}枚目",
