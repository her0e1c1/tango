    ...
    translation: {
      ...
      cardList: {
        ...
        filters: {
          ...
          scoreRange: "score {{minimum}}–{{maximum}}",
      ...
      deckFilter: {
        scoreRange: {
          ...
          minimum: {
            label: "Minimum",
            aria: "Minimum score",
            noLimitDescription: "A dash means no minimum score.",
            description: "Include cards at or above this score.",
          },
          maximum: {
            label: "Maximum",
            aria: "Maximum score",
            noLimitDescription: "A dash means no maximum score.",
            description: "Include cards at or below this score.",
          },
          status: {
            range: "Score range: {{minimum}} to {{maximum}}.",
            minimumOnly: "Minimum score: {{minimum}}. No maximum score.",
            maximumOnly: "Maximum score: {{maximum}}. No minimum score.",
            noLimits: "No score limits.",
          },
          invalid: "Minimum score must not be greater than maximum score.",
        },
        tagFilter: {
          title: "Tags",
      ...
      studySession: {
        ...
        help: {
          ...
          actions: {
            ...
            cardDetails: "Show or hide score and study history",
    ...
    translation: {
      ...
      cardList: {
        ...
        filters: {
          title: "フィルター",
          noFilters: "フィルターなし",
          scoreRange: "スコア {{minimum}}～{{maximum}}",
          scoreMinimum: "スコア ≥ {{minimum}}",
          scoreMaximum: "スコア ≤ {{maximum}}",
      ...
      deckFilter: {
        scoreRange: {
          ...
          minimum: {
            label: "最小",
            aria: "最小スコア",
            noLimitDescription: "ダッシュは最小スコアの制限がないことを示します。",
            description: "このスコア以上のカードを含めます。",
          },
          maximum: {
            label: "最大",
            aria: "最大スコア",
            noLimitDescription: "ダッシュは最大スコアの制限がないことを示します。",
            description: "このスコア以下のカードを含めます。",
          },
          status: {
            range: "スコア範囲：{{minimum}}〜{{maximum}}。",
            minimumOnly: "最小スコア：{{minimum}}。最大スコアの制限はありません。",
            maximumOnly: "最大スコア：{{maximum}}。最小スコアの制限はありません。",
            noLimits: "スコアの制限はありません。",
          },
          invalid: "最小スコアは最大スコア以下にしてください。",
        },
        tagFilter: {
          title: "タグ",
      ...
      studySession: {
        ...
        help: {
          ...
          actions: {
            ...
            cardDetails: "スコアと学習履歴を表示または非表示にする",
