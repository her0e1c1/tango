...
const messages = {
  ...
  ja: {
    language: "ja",
    title: "Tangoを起動できません",
    description: "再読み込みするか、キャッシュを削除して初期化してください。初期化に失敗する場合は、他のTangoのタブを閉じ、ブラウザーのストレージ設定を確認してください。",
    reload: "再読み込み",
    reset: "キャッシュを削除して初期化",
    resetting: "Tangoを初期化しています…",
    confirm: "このブラウザーのデッキ・カード・学習記録・未同期の変更・設定を削除し、ログアウトします。同期済みのクラウドデータは削除しません。再起動にはインターネット接続が必要です。続けますか？",
