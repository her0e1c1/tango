...
import { buildCardCreateDto, buildCardUpdateDto, mapCardDocument } from "@/entities/card/api/cardDto";
import { buildDeckCreateDto, buildDeckUpdateDto, mapDeckDocument } from "@/entities/deck/api/deckDto";
import { FirestoreDocumentValidationError } from "@/shared/firebase/document-validation";
