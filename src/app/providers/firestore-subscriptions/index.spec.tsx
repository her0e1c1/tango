...
describe("FirestoreSubscriptionsProvider", () => {
  ...
  it("handles Card and Deck subscription errors locally", () => {
    render(<FirestoreSubscriptionsProvider />);
    expect(mocks.subscribeCards).toHaveBeenCalledWith("test-user", console.error);
    expect(mocks.subscribeDecks).toHaveBeenCalledWith("test-user", console.error);
  });
