...
import * as deckAdapter from "./firestoreDeck";

const uuid = UUID.v4;

vi.mock("@/shared/firebase/document-metadata", async (importOriginal) => ({
  ...(await importOriginal<typeof import("@/shared/firebase/document-metadata")>()),
  getTimestamp: vi.fn(),
}));
