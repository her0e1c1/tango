...
import { z } from "zod";
import { firestoreMetadataSchema, firestoreTimestampSchema, parseFirestoreDocument } from "@/shared/api";
...
export function parseStudySessionDocument(id: string, value: unknown): StudySessionDocument {
  return parseFirestoreDocument(studySessionDocumentSchema, "studySession", id, value);
}
